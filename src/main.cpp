...
hpdl1414 GLED1(HC595[7 + 8], HC595[6 + 8], HC595[5 + 8], HC595[4 + 8], HC595[1 + 8], HC595[2 + 8],
               HC595[3 + 8], PIN_D3_A0, PIN_D3_A1, HC595[0 + 8]);
hpdl1414 GLED2(HC595[7], HC595[6], HC595[5], HC595[4], HC595[1], HC595[2], HC595[3], PIN_D2_A0,
               PIN_D2_A1, HC595[0]);
...
void setup() {
    ...
    pinMode(PIN_EN_LIGHT, OUTPUT_OPEN_DRAIN);
